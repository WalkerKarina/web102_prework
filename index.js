...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; ++i) {
        ...
        const display =  ` <h3>${games[i].name}</h1> 
...
let artistStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length}. Currently, ${countUnfunded} ${countUnfunded > 1 ? "games" : "game"} remain unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
let moneyP = document.createElement("p");  
moneyP.innerHTML = artistStr; 
descriptionContainer.append(moneyP);
